  ...
  const fetchCreators = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Only show approved creators who have 0 ads
        setCreators(data.filter((c: any) => c.status === 'Approved' && c.adsCount === 0));
      }
    } catch (error) {
      console.error(error);
    } finally {
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Creators without Ads</h2>
        </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900">{new Date(creatorDetails.profile.createdAt).toLocaleDateString()}</p>
                      </div>
                    </div>
                    <div className="mt-4">
